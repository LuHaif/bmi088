...
double BMI088_GYRO_SEN = 2000.0/32768;
...
int16_t bmi088_accel_init(void)
{
    uint8_t res = 0;
...
void BMI088_read(float gyro[3], float accel[3], float *temperate)
{
    ...
    // printf("raw  %d  %d  %d\r\n",(int16_t)((buf[1]) << 8) | buf[0], (int16_t)((buf[3]) << 8) | buf[2], (int16_t)((buf[5]) << 8) | buf[4]);
    BMI088_gyro_read_muli_reg(BMI088_GYRO_CHIP_ID, gyro_buf, 8);
    if(gyro_buf[0] == BMI088_GYRO_CHIP_ID_VALUE)
    {
        bmi088_raw_temp = (int16_t)((gyro_buf[3]) << 8) | gyro_buf[2];
        gyro[0] = bmi088_raw_temp * BMI088_GYRO_SEN;
        bmi088_raw_temp = (int16_t)((gyro_buf[5]) << 8) | gyro_buf[4];
        gyro[1] = bmi088_raw_temp * BMI088_GYRO_SEN;
        bmi088_raw_temp = (int16_t)((gyro_buf[7]) << 8) | gyro_buf[6];
